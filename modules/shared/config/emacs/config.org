...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "boda"
    user-mail-address "6238558+bodadotsh@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mini/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mini/bin" "/profile/bin" "/Users/mini/.npm-packages/bin" "/Users/mini/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
